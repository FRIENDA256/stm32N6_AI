...
/* USER CODE BEGIN EC */
/* RTL8211F is a gigabit RGMII PHY. Without this define the generic NetX
   Ethernet driver treats a 1000M link state as its default 100M case. */
#ifndef ETH_PHY_1000MBITS_SUPPORTED
