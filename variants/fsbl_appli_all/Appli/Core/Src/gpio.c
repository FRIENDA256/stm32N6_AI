...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : TINY1C_VSYNC_Pin */
  GPIO_InitStruct.Pin = TINY1C_VSYNC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(TINY1C_VSYNC_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : TINY1C_CS_Pin */
  GPIO_InitStruct.Pin = TINY1C_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(TINY1C_CS_GPIO_Port, &GPIO_InitStruct);
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(AD_IRQ_EXTI_IRQn, 8, 0);
