...
#if !defined(APP_ENABLE_CACHEAXI)
  /*
   * ETH DMA descriptors and NetX packet buffers do not yet have CACHEAXI
   * clean/invalidate handling. Keep CACHEAXI disabled so Ethernet DMA stays
   * coherent while infrared/NPU integration is still in progress.
   */
  return;
#endif
