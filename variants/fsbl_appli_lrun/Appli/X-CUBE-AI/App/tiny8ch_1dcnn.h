/**
  ...
  ******************************************************************************
  */
#ifndef AI_TINY8CH_1DCNN_H
#define AI_TINY8CH_1DCNN_H

#include "tiny8ch_1dcnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TINY8CH_1DCNN_MODEL_NAME          "tiny8ch_1dcnn"
#define AI_TINY8CH_1DCNN_ORIGIN_MODEL_NAME   "tiny8ch_1dcnn"

/******************************************************************************/
#define AI_TINY8CH_1DCNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TINY8CH_1DCNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TINY8CH_1DCNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TINY8CH_1DCNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_TINY8CH_1DCNN_IN \
  ai_tiny8ch_1dcnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINY8CH_1DCNN_IN_SIZE { \
  AI_TINY8CH_1DCNN_IN_1_SIZE, \
}
#define AI_TINY8CH_1DCNN_IN_SIZE_BYTES { \
  AI_TINY8CH_1DCNN_IN_1_SIZE_BYTES, \
}
#define AI_TINY8CH_1DCNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TINY8CH_1DCNN_IN_1_HEIGHT      (1024)
#define AI_TINY8CH_1DCNN_IN_1_CHANNEL     (8)
#define AI_TINY8CH_1DCNN_IN_1_SIZE        (8192)
#define AI_TINY8CH_1DCNN_IN_1_SIZE_BYTES  (32768)

/******************************************************************************/
#define AI_TINY8CH_1DCNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TINY8CH_1DCNN_OUT \
  ai_tiny8ch_1dcnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINY8CH_1DCNN_OUT_SIZE { \
  AI_TINY8CH_1DCNN_OUT_1_SIZE, \
}
#define AI_TINY8CH_1DCNN_OUT_SIZE_BYTES { \
  AI_TINY8CH_1DCNN_OUT_1_SIZE_BYTES, \
}
#define AI_TINY8CH_1DCNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TINY8CH_1DCNN_OUT_1_CHANNEL     (4)
#define AI_TINY8CH_1DCNN_OUT_1_SIZE        (4)
#define AI_TINY8CH_1DCNN_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_TINY8CH_1DCNN_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tiny8ch_1dcnn
 ...
 * @ref ai_tiny8ch_1dcnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_tiny8ch_1dcnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tiny8ch_1dcnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tiny8ch_1dcnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TINY8CH_1DCNN_*
 * defines into file @ref tiny8ch_1dcnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tiny8ch_1dcnn_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TINY8CH_1DCNN_H */
